...
- Current issue scope includes browser-local IndexedDB workspaces, draft Meeting Note persistence, and browser-tab MediaRecorder capture. Keep provider API calls, real import/export, hosted sync, and background processing out of scope unless a later issue explicitly adds them.
